...
Use estes valores como padrão. Se o usuário tiver uma identidade visual própria, ela sobrepõe estes valores.

**Paleta de cores:**
- Fundo principal: `#FDFAF7` (off-white quente)
- Fundo alternativo: `#F5EFE6` (bege suave)
- Acento: `#C9A87C` (dourado rosado)
- Texto principal: `#2C2C2C` (quase preto)
- Texto secundário: `#6B6B6B` (cinza médio)
- Destaque claro: `#F0E8DC` (bege muito claro)
...
5. **Marca discreta mas presente**: Logo ou nome da marca no canto inferior de todos os slides (exceto stories se não couber).
...
<body>
  ...
  <p><!-- CORPO DO SLIDE --></p>
  <span class="brand">Estética Criativa</span>
