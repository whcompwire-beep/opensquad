...
5. Salve o output em `output/[data]-conteudo-rascunho.md`
...
**Reel**: Roteiro linha a linha + caption + variante A/B do hook
**Carrossel**: Todos os slides (mínimo 4) + caption + variante A/B do slide 1
**Feed Imagem Única**: Frase para imagem + caption curta + variante A/B
**Stories**: Sequência de 3-5 stories com descrição visual + copy + CTA final
...
O step está concluído quando todas as peças aprovadas têm conteúdo completo com variantes A/B.
